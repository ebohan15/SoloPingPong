...
// Step 08 .. jwt .. Draw everthingon canvas over and over again
function refreshCanvasFun() {
  console.log("refreshCanvasFun");
  paintCanvas();
  paintPaddles();
  ball.draw();
  paintScore();
...
var particleDir = 1; // var to conrol the direction of sparks
var particleCount = 20; // number of sparks when the ballhits the paddle


function increaseSpd() {
  // increase ball speed after every 4 poiints
  if(points % 4 === 0) {
